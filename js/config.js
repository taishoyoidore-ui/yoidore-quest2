...
const APP_CONFIG = {
  ...
  // ※制覇酒場数（min_visits）に応じて称号とレベルを判定
  fallbackHeroTitles: [
    { level: 1, min_visits: 0, title: '駆け出しの呑兵衛', badge_color: '#94a3b8', description: 'まだ1軒も巡っていない初期状態' },
    ...
    { level: 4, min_visits: 5, title: '酒場制覇の豪傑', badge_color: '#facc15', description: '5軒を制覇した頼もしい豪傑' },
    { level: 5, min_visits: 10, title: '大正の伝説マスター', badge_color: '#f43f5e', description: '10軒以上を制覇した伝説の呑兵衛' },
    { level: 6, min_visits: 20, title: '酔いどれ覇王', badge_color: '#c084fc', description: '大正区全域を掌握する至高の覇王' },
    { level: 7, min_visits: 33, title: '完全制覇グランドマスター', badge_color: '#eab308', description: '全33軒を完全制覇した神話の勇者' }
  ]
};
