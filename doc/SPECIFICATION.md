...
| **🏠 案内所（トップ）** | **不可**<br/>（今期固定） | **現在開催中シーズンの概要文・はしご酒の導き（3ステップ）・冒険の心得（注意事項）を表示**。 |
...
| **v2026.09.18.25** | 2026-09-18 | **冒険の書「酒場ロゴコレクション（図鑑風タイル）」刷新**<br>・ハシゴ済み酒場エリアを従来のテキストリストから全店ロゴタイルのグリッドUIに刷新。<br>・未制覇は暗転・反転、制覇でカラー＆ゴールド発光点灯。<br>・タイルタップで店舗名・訪問日時確認および酒場詳細画面への遷移モーダルを実装。 |
